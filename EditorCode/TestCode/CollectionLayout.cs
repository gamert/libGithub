...
public class CollectionLayout : MonoBehaviour
{
    ...
    {
        CollectionSceneLayout collectionSceneLayout = ApplicationManager.faeriaSceneManager.GetSceneLayout(FaeriaSceneManager.SceneType.COLLECTION) as CollectionSceneLayout;
        Account locAccount = ApplicationManager.dataManager.GetYouAccount();
        locAccount.currentGameMode = GameMode.COLLECTION;
        this.editedDeck = parDeck;
        this.UpdateMode(CollectionMode.DECK_EDITION);
    ...
    public IEnumerator ForceDeckTutorialCoroutine()
    {
        ...
        yield return (object)SceneLayout.WaitUntilInitialised(FaeriaSceneManager.SceneType.COLLECTION);
        /*Error: Unable to find new state assignment for yield return*/;
    }
